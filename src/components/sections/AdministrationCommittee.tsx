        ...
        <section className="py-20 md:py-32 bg-zinc-50 relative overflow-hidden border-t border-zinc-100">
            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10">
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-start mb-20">
                    <motion.div 
                        className="lg:col-span-4 relative mx-auto w-full max-w-[280px]"
                    ...
                    >
                        <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-zinc-100">
                            ...
                            <p className="text-foreground/80 leading-relaxed text-lg mb-6">
                                Established in 2012, the Foundation has facilitated more than 52,000+ free dialysis sessions through collaborations with 21 hospitals across Ernakulam and Idukki districts, while also donating 14 dialysis machines to strengthen treatment infrastructure and improve long-term access to care.
                            </p>
